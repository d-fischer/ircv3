...
export { BatchCapability as Batch } from './BatchCapability';
...
export { LabeledResponseCapability as LabeledResponse } from './LabeledResponseCapability';
export { MessageTagsCapability as MessageTags } from './MessageTagsCapability';
